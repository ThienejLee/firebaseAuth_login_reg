...
class RegistrationScreen extends StatelessWidget{
  ...
  Future<bool> registerUser(String emai, String pass, String name, String url) async{
        ...
        child: Container(
          ...
          child: Form(
            child: Column(
              ...
              children: <Widget>[
                Text("Registratrion", style: TextStyle(color: Colors.lightBlue, fontSize: 36, fontWeight: FontWeight.w500)),
